...
def process_markdown():
    ...
    try:
        predefined_keywords = {"dataset", "benchmark", "evaluation", "survey"}
        ...
        top_keywords = [keyword for keyword, _ in keyword_counts.most_common() if keyword not in predefined_keywords][:14]
        ...
        clear_folder(folder_to_clear)
        # Create directory for env-based grouping
    ...
    try:
        ...
        predefined_keywords = ["framework", "dataset", "benchmark", "evaluation", "survey"]
